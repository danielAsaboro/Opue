...
export default function HistoricalAnalyticsPage() {
    ...
    // Fetch data
    const { data: networkHistory, isLoading: loadingHistory, refetch: refetchHistory } = useNetworkHistory(getDays(timeRange), timeRange === '24h' ? 'hourly' : 'daily');
            ...
            <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p className="mt-1 text-gray-400">
                                Deep insights powered by indexed historical data
                            </p>
                        </div>
                ...
                <div className="mb-8 grid gap-6 lg:grid-cols-2">
                    ...
                    <ChartCard
                        ...
                        subtitle={`pNode count and health over ${timeRange}`}
                    >
                    ...
                    <ChartCard
                        ...
                        subtitle="Hourly snapshots of network metrics"
                    >
                    ...
                    <ChartCard
                        ...
                        subtitle="Total network storage over time"
                    >
                    ...
                    <ChartCard
                        ...
                        subtitle="pNode distribution by region"
                    >
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500">
                                    Historical data indexed every 30 seconds for deep analytics
                                </p>
                            </div>
                        </div>
